...
public class BusinessArticleListingFragment extends BaseArticleListingFragment {

    private Settings settings;

    public BusinessArticleListingFragment() {
        super();
    ...
    public int getGridViewId() {
        return R.id.rvBusinessResults;
    }

    @Override
    public int getLayoutId() {
        return R.layout.fragment_business_article_listing;
    }
